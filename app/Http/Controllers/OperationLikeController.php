...
use App\Http\Requests\StoreOperationLikeRequest;
use App\Http\Requests\UpdateOperationLikeRequest;
use App\Models\Like;
...
class OperationLikeController extends Controller
{
    /**
 ...
 public function getLikes(Request $request)
    {
        ...
        try {
            ...
            $latestLikes  = OperationLike::with('user:id,name')
            ...
            $totalLikesCount = OperationLike::where('tweet_id', $postId)->count();
 ...
 public function store(Request $request)
{
    ...
    try {
        ...
        if ($timeline != NULL) {
            $like = OperationLike::where('tweet_id', $request->tweet_id)
     ...
     */
    public function show(OperationLike $operationLike)
    {
        //
    }
     ...
     */
    public function edit(OperationLike $operationLike)
    {
        //
    }
     ...
     */
    public function update(UpdateOperationLikeRequest $request, OperationLike $operationLike)
    {
        //
    }
     ...
     */
    public function destroy(OperationLike $operationLike)
    {
        //
    }
}
