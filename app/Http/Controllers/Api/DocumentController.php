...
class DocumentController extends BaseController
{
    ...
    public function index($patient_id)
    {
        ...
        $document = Document::with('patient:id,first_name,last_name')->where('patient_id', $patient_id)->get();
        if ($document->isEmpty()) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $document->date = Carbon::createFromFormat('d-m-Y', $validatedData['date'])->format('Y-m-d');;
