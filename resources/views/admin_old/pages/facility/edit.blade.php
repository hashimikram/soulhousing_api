                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form method="POST" action="{{ route('facility.update', $facilityEdit->id) }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('text') is-invalid @enderror"
                                                name="text" value="{{ $facilityEdit->address }}"
                                    ...
                                    <button type="submit" class="text-center btn btn-dark btn-block">Edit Facility</button>
                                </form>
                            </div>
                        </div>
                    </div>
