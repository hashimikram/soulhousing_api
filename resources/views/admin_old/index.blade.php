            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-1">
                        <div class="card-body">
                            <h3 class="text-white card-title">Products Sold</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">4565</h2>
                                <p class="mb-0 text-white">Jan - March 2019</p>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-2">
                        <div class="card-body">
                            <h3 class="text-white card-title">Net Profit</h3>
                            <div class="d-inline-block">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-3">
                        <div class="card-body">
                            <h3 class="text-white card-title">New Customers</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">4565</h2>
                                <p class="mb-0 text-white">Jan - March 2019</p>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-4">
                        <div class="card-body">
                            <h3 class="text-white card-title">Customer Satisfaction</h3>
                            <div class="d-inline-block">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="pb-0 card-body d-flex justify-content-between">
                                    <div>
                                    ...
                                    <div>
                                        <ul>
                                            <li class="mr-3 d-inline-block"><a class="text-dark" href="#">Day</a></li>
                                            <li class="mr-3 d-inline-block"><a class="text-dark" href="#">Week</a>
                                            </li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="px-0 card-body">
                            <h4 class="px-4 mb-3 card-title">Todo</h4>
                            <div class="todo-list">
                            ...
                            <div class="active-member">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-xs">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="./images/avatar/1.jpg" class="mr-3 rounded-circle"
                                                        alt="">Sarah Smith</td>
                                                <td>iPhone X</td>
                                                <td>
                                                ...
                                                <td><i class="mr-2 fa fa-circle-o text-success"></i> Paid</td>
                                                <td>
                                                    <span>Last Login</span>
                                                    <span class="pl-3 m-0">10 sec ago</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><img src="./images/avatar/2.jpg" class="mr-3 rounded-circle"
                                                        alt="">Walter R.</td>
                                                <td>Pixel 2</td>
                                                ...
                                                <td>
                                                    <span>Last Login</span>
                                                    <span class="pl-3 m-0">50 sec ago</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><img src="./images/avatar/3.jpg" class="mr-3 rounded-circle"
                                                        alt="">Andrew D.</td>
                                                <td>OnePlus</td>
                                                ...
                                                <td><i class="mr-2 fa fa-circle-o text-warning"></i> Pending</td>
                                                <td>
                                                    <span>Last Login</span>
                                                    <span class="pl-3 m-0">10 sec ago</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><img src="./images/avatar/6.jpg" class="mr-3 rounded-circle"
                                                        alt=""> Megan S.</td>
                                                <td>Galaxy</td>
                                            ...
                                            <tr>
                                                <td><img src="./images/avatar/4.jpg" class="mr-3 rounded-circle"
                                                        alt=""> Doris R.</td>
                                                <td>Moto Z2</td>
                                            ...
                                            <tr>
                                                <td><img src="./images/avatar/5.jpg" class="mr-3 rounded-circle"
                                                        alt="">Elizabeth W.</td>
                                                <td>Notebook Asus</td>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                    ...
                    <div class="card">
                        ...
                        <div class="pt-4 card-body border-top">
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-xxl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="activity">
                                <div class="pt-3 pb-3 media border-bottom-1">
                ...
                <div class="col-xl-6 col-lg-12 col-sm-12 col-xxl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="mb-0 card-title">Store Location</h4>
