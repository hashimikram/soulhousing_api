...
@section('page_title', 'Admin Dashboard') @section('content')
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div
                        ...
                        <h3 class="card-title align-items-start flex-column text-white pt-15">
                            <span class="fw-bold fs-2x mb-3">Patients Information</span>
                            <div class="fs-4 text-white">
                                <span class="opacity-75">There are</span>
                                <span class="position-relative d-inline-block">
                                <a href="#"
                                   class="link-white opacity-75-hover fw-bold d-block mb-1">{{$unsigned_encounters}} Un Sign Encounters</a>
                                    <!--begin::Separator-->
                                <span
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$all_patients}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-500 fw-semibold fs-6">Total Registered Patients</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$unassign_patients}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">Un-Assign Patients</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$assign_patients}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">Assign Patients</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$signed_encounters}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">Sign Encounters</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
