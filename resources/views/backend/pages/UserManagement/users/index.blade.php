        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 myTable" id="">
                        <!--begin::Table head-->
                        <thead>
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @foreach ($users as $data)
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="{{ route('user.show', $data->id) }}">
                                                <div class="symbol-label">
                                                    <img src="{{ image_url($data->userDetail->image) }}"
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('user.show', $data->id) }}"
                                                ...
                                                {{ $data->name }} {{ $data->userDetail->middle_name }}
                                    ...
                                    <td>
                                        {{ formatDate($data->userDetail->date_of_birth) }}
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="#"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-button"
                                            data-id="{{ $data->id }}">
                                            <span class="svg-icon svg-icon-3">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
