...
@section('breadcrumb_title','Operation List')
@section('breadcrumb_li_1','Home')
@section('breadcrumb_li_2','Operation Management - Operation')
@section('breadcrumb_href', route('dashboard'))
@section('operation_management_li', 'here show')
@section('operation_a', 'active')
@section('page_title','All Operations')
@section('content')
    ...
    @include('backend.pages.partials.new_operation_model')
@endsection
