...
<div class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-activate="{default: true, lg: false}"
     data-kt-drawer-direction="start" data-kt-drawer-name="app-sidebar" data-kt-drawer-overlay="true"
     data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle" data-kt-drawer-width="225px" id="kt_app_sidebar"
     style="background-color: #14457b;">
    <!--begin::Logo-->
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <div
            ...
            data-kt-toggle="true" data-kt-toggle-name="app-sidebar-minimize" data-kt-toggle-state="active"
            data-kt-toggle-target="body" id="kt_app_sidebar_toggle">
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
             data-kt-scroll-activate="true" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer"
             data-kt-scroll-height="auto" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true"
             data-kt-scroll-wrappers="#kt_app_sidebar_menu" id="kt_app_sidebar_menu_wrapper">
            <!--begin::Menu-->
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" data-kt-menu="true"
                ...
                @if (Auth::user()->user_type == 'super_admin' || in_array('6', json_decode($permission->permissions)))
                    <div class="menu-item @yield('operation_management_li') menu-accordion"
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link  @yield('operation_a')" href="{{ route('operations.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Manage</span>
                ...
                @if (Auth::user()->user_type == 'super_admin' || in_array('8', json_decode($permission->permissions)))
                    <div class="menu-item @yield('encounter_management_li') menu-accordion"
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link  @yield('encounter_a')" href="{{ route('encounters.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Manage</span>
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                @if (Auth::user()->user_type == 'super_admin' || in_array('9', json_decode($permission->permissions)))
                    <div class="menu-item @yield('website_setup_li') menu-accordion"
                         data-kt-menu-trigger="click">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link  @yield('website_setup_a')"
                                   href="{{ route('website-setup.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                @if (Auth::user()->user_type == 'super_admin' || in_array('10', json_decode($permission->permissions)))
                    <div class="menu-item @yield('scheduling_li') menu-accordion"
                         data-kt-menu-trigger="click">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link  @yield('scheduling_a')"
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                @if (Auth::user()->user_type == 'super_admin' || in_array('11', json_decode($permission->permissions)))
                    <div class="menu-item @yield('admission_li') menu-accordion"
                         data-kt-menu-trigger="click">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link  @yield('admission_a')"
