    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--begin::Menu toggle-->
                    <a class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                       data-kt-menu-attach="parent"
                       data-kt-menu-placement="bottom-end" data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                       href="#">
                    ...
                    <div
                        ...
                        data-kt-element="theme-mode-menu" data-kt-menu="true">
                        <!--begin::Menu item-->
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a class="menu-link px-5" href="../../demo1/dist/apps/projects/list.html">
                        ...
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5" data-kt-menu-offset="-15px, 0"
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link px-5" href="../../demo1/dist/account/billing.html">Billing</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link px-5"
                                       href="../../demo1/dist/account/statements.html">Payments</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link d-flex flex-stack px-5"
                                       href="../../demo1/dist/account/statements.html">Statements
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content px-3">
                                        <label
                                            ...
                                            <input checked="checked" class="form-check-input w-30px h-20px"
                                                   name="notifications" type="checkbox" value="1"/>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a class="menu-link px-5" href="../../demo1/dist/account/statements.html">My
                                Statements</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        ...
                        <div class="menu-item px-5" data-kt-menu-offset="-15px, 0"
                            ...
                            <a class="menu-link px-5" href="#">
												...
												<img alt=""
                                                     ...
                                                     src="assets/media/flags/united-states.svg"/></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <!--begin::Menu item-->
                        ...
                        <div class="menu-item px-5">
                            <a class="menu-link px-5"
                               href="../../demo1/dist/authentication/layouts/corporate/sign-in.html">Sign
                                Out</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
